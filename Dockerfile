...
#Adopted and Simplified from John Exby's Docker WRF
ENV WRF_VERSION 3.9.1
...
RUN yum -y install netcdf-openmpi-devel.x86_64 netcdf-fortran-openmpi-devel.x86_64 netcdf-fortran-openmpi.x86_64 hdf5-openmpi.x86_64 openmpi.x86_64 openmpi-devel.x8\
6_64 \
&& yum clean all
